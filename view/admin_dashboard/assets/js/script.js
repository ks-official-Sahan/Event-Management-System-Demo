    ...
    if (request.readyState === 4) {
      ...
      if (request.status === 200) {
        ...
        for (var obj of resObj) {
          ...
          const stats = [
            "Currently have any Event concerns or symptoms: ",
            "Been diagnosed with any chronic Event conditions recently: ",
            ...
            "Able to maintain Eventy and balanced diet: ",
            "Aware of the available mental Event resources and support: ",
            "Utilized any mental Event rosources provided by the company: ",
